...
public class VueController implements Initializable {
    ...
    ObservableList<String> AgeList = FXCollections.observableArrayList("5","10","20");
    ...
    ObservableList<String> VilleList = FXCollections.observableArrayList("Castres","Maroc","Toulouse");
    ...
    Animal animal1 = new Animal("Chat","Cannelle","photo","Labrador", 2, "Femelle", "Petit","Maroc");
	Animal animal2 = new Animal("Chien","Fantasia","photo","Européen", 7, "Mâle", "Moyen","Toulouse");
	Animal animal3 = new Animal("Chien","Bali","photo","Croisé Berger", 8, "Femelle", "Grand","Castres");
    
	ObservableList<Animal> listAnimal = FXCollections.observableArrayList(animal1, animal2, animal3);
